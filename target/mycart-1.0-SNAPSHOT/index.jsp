...
<%@page import="com.rohitdemo.Dao.ProductDao"%>
<%@page import="java.util.List"%>
<%@page import="com.rohitdemo.entities.Product"%>
        ...
        <div class="row mt-3 mx-2">
            ...
            <div class="col-md-10">
                ...
                <div class="row mt-4">
                    ...
                    <img src="img/products/<%= p.getpPhoto() %>" style="max-height: 200px; max-width: 100%; width: auto;"  class="card-img-top" alt="..." m-2>
