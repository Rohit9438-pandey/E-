 ...
 */
package com.rohitdemo.servlets;

import com.rohitdemo.Dao.CategoryDao;
import com.rohitdemo.Dao.ProductDao;
import com.rohitdemo.entities.Category;
import com.rohitdemo.entities.Product;
import com.rohitdemo.helper.FactoryProvider;
import java.io.File;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            else if(op.trim().equals("addproduct"))
            {
              ...
              //find out the path to uupload photo
